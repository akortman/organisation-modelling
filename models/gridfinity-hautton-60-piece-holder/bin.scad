/**
 * Derived from gridfinity_extended_openscad (submodules/gridfinity_extended_openscad/gridfinity_basic_cup.scad)
 */

include <../../submodules/gridfinity_extended_openscad/modules/gridfinity_constants.scad>
use <../../submodules/gridfinity_extended_openscad/modules/module_gridfinity_cup.scad>
use <../../submodules/gridfinity_extended_openscad/modules/module_gridfinity_block.scad>
...
filled_in = "enabled"; //[disabled, enabled, enabledfilllip:"Fill cup and lip"]
...
module bin() {
  translate([0, depth[0] * pitch[1] / 2, -height[0] * pitch[2]])
    set_environment(
      width=width,
      depth=depth,
      height=height,
